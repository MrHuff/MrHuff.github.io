...
The institution marks on the background timeline are kept as local assets,
unaltered in appearance, and are used only to identify Robert Hu's past
affiliations. All marks and trademarks remain the property of their respective
owners.

- Graphcore: [Graphcore website](https://www.graphcore.ai/), using the compact
  symbol served from its official site.
- Amazon: [Amazon press centre](https://press.aboutamazon.com/logos), using the
  official Amazon logo asset.
...
- Stockholm School of Economics: [SSE visual identity](https://www.hhs.se/about-us/visual-identity/),
  using the official stamp asset.
